...
// Provider implements orchestra.DriverProvider for the VZ (Apple Virtualization) driver.
type Provider struct{}

// NewProvider returns a new VZ DriverProvider.
func NewProvider() *Provider { return &Provider{} }

// Name implements orchestra.DriverProvider.
func (p *Provider) Name() string { return "vz" }
