...
// Provider implements orchestra.DriverProvider for the Fly.io driver.
type Provider struct{}

// NewProvider returns a new Fly.io DriverProvider.
func NewProvider() *Provider { return &Provider{} }

// Name implements orchestra.DriverProvider.
func (p *Provider) Name() string { return "fly" }
